...
3. Skriv ditt mobilnummer, epost (valfritt) och arbetsplatskod i de avsedda rutorna.
4. Välj vårdcentralen du är listad på i rullisten, hittar du inte din vårdcentral, välj ”Annan”.
5. Efter att du legitimerat dig med BankID är registreringen klar.
6. Om du fyllt i epostfältet under registreringen skickas ett mail med referensnumret till epostadressen du angett.

# Registrera Prov

|Direkttest refnr.|Mobil (SMS)|
|---|---|
|123 456 789 0|________________|
