...
An Al Strategy for Sweden has been written to guide politicians, business leaders, decision-makers, civil servants, or changemakers with ambition and responsibility to lead and develop Sweden, the Swedish ecosystem, or individual organizations and companies towards a positive future through one of the most transformative times in history.
...
*   Elissa Strome, Executive Director, [Pan-Canadian AI Strategy at CIFAR](https://www.cifar.ca/ai/)
*   José-Marie Griffiths, President at [Dakota State University](https://dsu.edu/) and one of the commissioners in the [National Security Commission on Artificial Intelligence](https://www.nscai.gov/)
*   Laurence Liew, Director, AI Innovation at [AI Singapore](https://www.aisingapore.org/)
...
The Vision can also be expressed as Sweden striving to become a worldwide benchmark for how Al is embedded nationally and generates sustainable value throughout businesses and society with a positive impact globally.
...
Reference: [HAI Al Index Report 2023](HAI Al Index Report 2023)

**Speed | The extreme pace of Al development must be recognized and acted upon**
...
Availability | General Al technology is widely available, while data is often proprietary
Mature and powerful Al technologies are already today freely available or accessible as ready-
to-be-used services and tools. Although generative Al is used to substantially improve the quality
...
While Al technology is typically openly available, data held by companies and organizations is
often proprietary and constitutes untapped value and opportunity for strengthened
competitiveness and societal solutions. Hence, a strategy aiming at accelerating the use of Al
broadly should prioritize investments driving adoption and value-creation based on such
proprietary data.
In academia and research institutes, there is also an untapped potential for adopting existing Al
technologies and accelerating and enhancing research in various fields (e.g. medicine, biology,
materials, etc).
As the adoption of Al happens broadly, research related to the consequences on society
becomes increasingly important. Such research could include research on the economic
potential, societal value, consequences on the labor market, and the safety of Al systems.
Leadership | Broad Al adoption requires bold leadership
Determined and knowledgeable leadership understanding the potential value and risks of Al,
setting direction, and making concrete investments is critical for any nation, organization, or
company that wants to broadly benefit from the opportunities of Al. Lack of leadership leads to
missed opportunities and increased risks of Al being used in ways not aligned with responsible Al
principles, not beneficial for society, or misaligned with other objectives.
Further, the competence of an organization will determine how well and sustainably Al solutions
will be built and deployed. Leaders understanding the potential of Al therefore immediately and
...
simultaneously creating value and solving problems using currently available Al solutions. This
...
# Collaboration | Al has unique properties requiring collaboration in ecosystems
...
As mentioned in the Vision above, the Swedish values and strengths should be embraced and considered when developing an Al strategy. As a nation, Sweden is known for its social stability, highly developed welfare state, high levels of equality, a skilled workforce, and a business environment that fosters innovation and entrepreneurship. Furthermore, Sweden offers a competitive, open economy with access to new products, technologies, and innovations, a well- educated workforce, and a stable political environment.
...
However, larger investments in Sweden are necessary. Research and development (R&D) is a key driver of digital innovation, and according to [OECD Going Digital](https://www.oecd.org/going-digital/), R&D expenditure in information industries in Sweden is a lagging indicator.
...
For reference, one of the most relevant countries for Sweden to collaborate with, is Canada where between 2022 and 2023, $2.57 billion was invested in Al research in the country, as total Al investment reached $8.64 billion. [Read more here](https://example.com).

[Read further on the top 10 Countries Leading in Al Research & Technology in 2023](https://example.com)
...
According to the [Global AI Index](https://www.tortoisemedia.com/2023/12/04/global-ai-index-2023/) Sweden ranks number 17 in total, and as follows in the seven categories:
...
Tortoise Media's [Global AI Index](https://www.tortoisemedia.com/2023/12/04/global-ai-index-2023/) is one of the most established global benchmarks for countries and encompasses several important metrics and data.
...
This [comparative analysis by Brookings into national AI strategies and capabilities](https://www.brookings.edu/research/benchmarking-national-ai-strategies-2021/) also complements the Global AI Index and is worth reading.


# The heart of the strategy & Key principles

As set out in the Executive summary, An Al Strategy for Sweden encourages Sweden to recognize
the necessity of Al and apply a fully adoption-centric strategy that ensures significant and broad
...
To guide politicians, business leaders, decision-
makers, civil servants, and changemakers, the
...
investing and demonstrating real value by Al, already exist in both private and public sectors.
...
global example of how to create substantial value through Al adoption.

This strategy's focus on frontrunners is based on the trend that breakthroughs typically appear in
companies and sectors where Al is applied to real problems, often in service and product
development.
...
The development of strategic and important knowledge, technology, and solutions for sovereignty, independence, and scaled adoption should be incentivized and built-in broad collaborations, and made available as widely as possible. Strategic knowledge, technology, and solutions (and other relevant resources) must evolve and should include national computational infrastructure, foundational models, privacy-preserving methods, access to data, data-sharing mechanisms and structures, and Al adoption tools for leaders.

Al Sweden (among others) has demonstrated that the willingness among international and Swedish companies and organizations to jointly invest in knowledge, technology, and solutions enabling the adoption of Al is significant. When incentivized by government funding and structured on a truly collaborative basis with strong sharing mechanisms, the return on investment can be significant.

Furthermore, to fully benefit from Al, strategic investments addressing specific sectors' underlying prerequisites are necessary. This specifically applies to the public sector, where investments in digitalization, data platforms, and data governance are still required.

## Ensure responsible use and good governance

By building on the Swedish values centered around democracy, inclusion, transparency, and diversity, Sweden has the opportunity to scale and govern the use of Al in a responsible way. Al systems should be designed, operated, and governed in a manner that respects laws, human rights, values, and cultural diversity. This includes mitigating risks such as bias and discrimination, as well as risks related to security and safety.

As a principle, responsible use of Al should be approached and ensured by active experimentation and exploration while developing Al solutions in practice, and by fully recognizing the need for diversity and inclusion of stakeholders, domain experts, end users, and Al developers in all parts of the process.

Moreover, leaders in any organization should ensure that employees have access to, and proficiency in, available modern tools independent of for example their age, native language, disabilities, educational background, or where they live in Sweden. Related to Al, this extends to providing prerequisites for everyone to use Al responsibly and minimize the risks that groups of people are left behind.

Responsible use of Al also means that we have a responsibility to use Al where appropriate and to address our time's most pressing global challenges.


Invest in strategic knowledge, technology, and solutions shared by many

To maximize the benefits of Al, Sweden should scale initiatives that catalyze collaboration across
...
*   [OECD overview of national Al strategies (from 2021)](link_to_oecd_ai_strategies)
*   [USA National Al R&D Strategy](link_to_usa_ai_strategy)
*   [USA National Security Strategy on Al](link_to_usa_security_strategy_ai)
*   [USA NATIONAL ARTIFICIAL INTELLIGENCE RESEARCH AND DEVELOPMENT STRATEGIC PLAN, 2023 UPDATE Strengthening and Democratization the U.S. Al Innovation System](link_to_usa_ai_research)
*   [Pan-Canadian Al Strategy](link_to_canada_ai_strategy).
*   [UK National Al Strategy](link_to_uk_ai_strategy)
*   [Singapore National Al Strategy](link_to_singapore_ai_strategy)
*   [Japan Revised Al Strategy](link_to_japan_ai_strategy).
*   [Norway National Strategy Al](link_to_norway_ai_strategy)
*   [Denmark National Strategy for Al](link_to_denmark_ai_strategy)
*   [Australia Strategy for Generative Al](link_to_australia_ai_strategy)
*   [NATO AI Strategy](link_to_nato_ai_strategy)
*   [EU thoughts on Al Strategy](link_to_eu_ai_strategy).

REFERENCES TO STRATEGIES AND GUIDELINES RELATED TO RESPONSIBLE AI

*   [EU ethics guidelines for trustworthy Al](link_to_eu_ethics_ai)
*   [UNESCO: recommendation on the ethics of artificial intelligence](link_to_unesco_ethics_ai)
*   [OECD: OECD Al Principles overview](link_to_oecd_principles_ai)
*   [EU AI Act Proposal](link_to_eu_ai_act)
*   [NATO AI Strategy](link_to_nato_ai_strategy)
...
## INVESTMENTS
Indicators related to investments are very relevant as they both give a perspective on the belief in the future value to be realized, but also serve as a proxy for the current leadership commitment regardless of level.
Metrics should be on government investments as well as investments on a sector level.
Given the importance of collaboration, the framework of indicators should also measure investments in cross-sector collaboration, and international collaboration as well as investments in knowledge, technology, data, and solutions related to sovereignty, independence, and scaled adoption.
...
Launching this first version of An AI Strategy for Sweden, AI Sweden is committed to taking responsibility and contributing to the journey to a defined and adopted national strategy with clear priorities, investments, and allocated responsibilities, [learn more here!](https://example.com)

For questions about the strategy as such, reach out to [Martin Svensson](mailto:martin.svensson@example.com) or [Mikael Ljungblom](mailto:mikael.ljungblom@example.com).

[Sign up](https://example.com) to receive news about the strategy.

## About AI Sweden

[AI Sweden](https://example.com) is the national center for applied AI and brings together 120+ partners across the public and private sectors as well as academia. AI Sweden is funded by Vinnova, regions and municipalities, and its partners. Together, we invest in generating tools and resources to accelerate the use of AI for the benefit of our society, our competitiveness, and everyone living in Sweden.
