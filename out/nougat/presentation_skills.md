...
The appendix is organized as follows. In Section 2.1, we show how to compute the \(\mathcal{O}(\log(\log(\log(\log(\log(\log(\log(\log(\log(\log(\log(\log(\log(\log(\log(\log( \log(\log(\log(\log(\log(\log(\log(\log(\log(\log(\log(
...
**10. Don't Be Afraid To Pause Every Now And Then Don't you just love dramatic pauses? That moment of silence right before the presenter delivers a punchline? You can practically feel the anticipation building up inside you, and your thoughts turn towards guessing what the presenter is going to say.** 
