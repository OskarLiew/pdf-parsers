...
| [General OCR theory](https://huggingface.co/stepfun-ai/GOT-OCR2_0)               | Image                                             | text, md           | End-to-end general OCR model                                                                          | Deep learning model                      | Apache                | Yes    |
...
| [pdftext](https://github.com/VikParuchuri/pdftext)                               | PDF                                               | text, json         | Structured pdf parser. Like PyMuPDF but permissive license.                                           | Python library / CLI                     | Apache                | Yes    |
